...
WhereModel* where(NSString *column,OPR opr,id compareValue,DataType type){
    ...
    WhereModel *wm = [[WhereModel alloc] init];
...
- (id)copyWithZone:(nullable NSZone *)zone{
    WhereModel * w = [[WhereModel alloc] init];
