...
@class FXSDKFMStatement;

/** Represents the results of executing a query on an `<FXSDKFMDatabase>`.
...
@interface FXSDKFMResultSet : NSObject {
    FXSDKFMDatabase          *_parentDB;
    FXSDKFMStatement         *_statement;
...
/** `FXSDKFMStatement` used by result set. */

@property (atomic, retain) FXSDKFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<FXSDKFMStatement>`
 
 @param statement A `<FXSDKFMStatement>` to be performed
 
 @param aDB A `<FXSDKFMDatabase>` to be used
 
 @return A `FXSDKFMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(FXSDKFMStatement *)statement usingParentDatabase:(FXSDKFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(FXSDKFMDatabase *)newDb;
