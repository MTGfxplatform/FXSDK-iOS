...
/** Category of additions for `<FXSDKFMDatabase>` class.
...
@interface FXSDKFMDatabase (FXSDKFMDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `FXSDKFMDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `FXSDKFMResultSet` of schema; `nil` on error.
