...
+(NSString *)queryLinesWithColumns:(NSArray <NSString *>*)columnNames inTable:(NSString *)tableName where:(FXWhereModel *)FXWhereModel{
    ...
    if (FXWhereModel.sqlString) {
        [sqlString appendFormat:@" WHERE %@",FXWhereModel.sqlString];
    }
   return sqlString.copy;
}
...
+(NSString *)queryLinesWithColumns:(NSArray <NSString *>*)columnNames inTable:(NSString *)tableName where:(FXWhereModel *)whereModel orderBy:(NSString *)columnName ascend:(BOOL)isAscend limit:(NSUInteger)lim{
    NSString * str = [self queryLinesWithColumns:(NSArray <NSString *>*)columnNames inTable:(NSString *)tableName where:(FXWhereModel *)whereModel orderBy:(NSString *)columnName ascend:(BOOL)isAscend];
...
+(NSString *)queryLinesWithColumns:(NSArray <NSString *>*)columnNames distinct:(BOOL)isDistinct inTable:(NSString *)tableName where:(FXWhereModel *)FXWhereModel orderBy:(NSString *)columnName ascend:(BOOL)isAscend{
    NSString *sqlString = [self queryLinesWithColumns:columnNames inTable:tableName where:FXWhereModel orderBy:columnName ascend:isAscend];
    if (isDistinct) {
...
+(NSString *)queryLinesWithColumns:(NSArray <NSString *>*)columnNames distinct:(BOOL)isDistinct inTable:(NSString *)tableName where:(FXWhereModel *)whereModel orderBy:(NSString *)columnName ascend:(BOOL)isAscend limit:(NSUInteger)lim{
    NSString * str = [self queryLinesWithColumns:(NSArray <NSString *>*)columnNames distinct:(BOOL)isDistinct inTable:(NSString *)tableName where:(FXWhereModel *)whereModel orderBy:(NSString *)columnName ascend:(BOOL)isAscend];
    return [[str stringByAppendingFormat:@" limit %ld", (unsigned long)lim] copy];
}
...
+(NSString *)updateWithRow:(NSDictionary <NSString *,id>*)row inTable:(NSString *)tableName where:(FXWhereModel *)FXWhereModel{
    ...
    if (FXWhereModel.sqlString) {
        [valueString appendFormat:@" WHERE %@",FXWhereModel.sqlString];
    }
    [sqlString appendString:valueString];
    return sqlString.copy;
}
